...
class MixUpTrainer(IICMultiHeadTrainer):
    ...
    def __init__(self, model: Model, train_loader_A: DataLoader, train_loader_B: DataLoader, val_loader: DataLoader,
                 max_epoch: int = 100, save_dir: str = './runs/IICMultiHead', checkpoint_path: str = None, device='cpu',
                 head_control_params: dict = {}, mixup_weight: float = 0, use_sobel: bool = True,
    ...
    def _trainer_specific_loss(self, tf1_images, tf2_images, head_name):
        ...
        :return: loss
        """
        orignal_loss = super(MixUpTrainer, self)._trainer_specific_loss(tf1_images, tf2_images, head_name)
        mixup_loss = 0
        if self.mixup_weight > 0:
            ...
            mixup_loss = super(MixUpTrainer, self)._trainer_specific_loss(tf1_images, mix_images, head_name) + \
                         super(MixUpTrainer, self)._trainer_specific_loss(tf2_images, mix_images, head_name)
