...
class SemiSegTrainer(_Trainer):
    ...
    def __init__(self, model: Model, labeled_loader: DataLoader, unlabeled_loader: DataLoader, val_loader: DataLoader,
                 ...
                 config: dict = None, max_iter: int = 100, axis=(1, 2, 3), **kwargs) -> None:
        self.axis = axis
    ...
    def __init_meters__(self) -> List[Union[str, List[str]]]:
        meter_config = {
            ...
            "valdice": SliceDiceMeter(C=self.model.arch_dict["num_classes"], report_axises=self.axis),
            "valbdice": BatchDiceMeter(C=self.model.arch_dict["num_classes"], report_axises=self.axis),
        }
