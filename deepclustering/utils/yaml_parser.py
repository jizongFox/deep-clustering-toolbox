...
class YAMLArgParser(object):
    ...
    def __new__(
        ...
        yaml_args: List[Dict[str, Any]] = [
            cls.parse_string(f, sep_1=cls.k_v_sep1, sep_2=cls.k_v_sep2, type_sep=cls.type_sep) \
            for f in args
        ]
    ...
    def _setup(cls) -> List[str]:
        ...
        return args.strings  # return a list of string using space, default by argparser.
