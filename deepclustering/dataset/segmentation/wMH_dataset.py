...
class WMHDataset(MedicalImageSegmentationDataset):
    download_link = "https://drive.google.com/uc?export=download&confirm=amXo&id=1hc9xy0bNuWdwlfUS-XNs8shiu0p3H8kD"
    zip_name = "WMH.zip"
    folder_name = "WMH"
...
class WMHSemiInterface(MedicalDatasetSemiInterface):
    def __init__(
        self,
        root_dir=DATA_PATH,
