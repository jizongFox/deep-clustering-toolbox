...
class SemiDatasetInterface(object):
    ...
    def __init__(self, DataClass: Dataset, data_root: str,
    ...
    @abstractmethod
    def _init_train_and_test_test(self, transform, target_transform, *args, **kwargs) \
    ...
    def SemiSupervisedDataLoaders(
        ...
        labeled_index, unlabeled_index = self._draw_indices(train_set, self.labeled_sample_num)
