...
"""
__all__ = ["SVHNClusteringDatasetInterface", "SVHNSemiSupervisedDatasetInterface", "svhn_naive_transform",
...
class SVHNSemiSupervisedDatasetInterface(SemiDataSetInterface):
    ...
    def __init__(self, data_root: str = DATA_PATH, labeled_sample_num: int = 1000, seed: int = 0,
        ...
        super().__init__(SVHN, data_root, labeled_sample_num, seed, batch_size, labeled_batch_size,
