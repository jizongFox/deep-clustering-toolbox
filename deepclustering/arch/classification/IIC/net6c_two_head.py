...
class ClusterNet6cTwoHeadHead(nn.Module):
    def __init__(self, input_size: int = 64, output_k: int = 10, num_sub_heads: int = 5, semisup=False,
...
class ClusterNet6cTwoHead(VGGNet):
    ...
    def __init__(self, num_channel: int = 3, input_size: int = 64, output_k_A: int = 10, output_k_B: int = 10,
                 num_sub_heads: int = 5, semisup: bool = False,
                 batchnorm_track: bool = True):
        ...
        self.head_A = ClusterNet6cTwoHeadHead(input_size=input_size, output_k=output_k_A,
...
ClusterNet6cTwoHead_Param = {'num_channel': 3, 'input_size': 64, 'output_k_A': 10, 'output_k_B': 10,
                             'num_sub_heads': 5, 'semisup': False}
